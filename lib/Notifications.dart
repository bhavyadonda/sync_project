        ...
        children: <Widget>[
          ...
          Positioned(
            ...
            children: <Widget>[
              ...
              Pinned.fromSize(
                bounds: Rect.fromLTWH(35.0, 75.0, 187.0, 35.0),
                size: Size(239.0, 120.0),
                pinLeft: true,
                pinRight: true,
                pinBottom: true,
              ...
              Pinned.fromSize(
                bounds: Rect.fromLTWH(140.0, 45.0, 82.0, 25.0),
                size: Size(239.0, 120.0),
                pinRight: true,
                fixedWidth: true,
                fixedHeight: true,
              ...
              Pinned.fromSize(
                bounds: Rect.fromLTWH(0.0, 27.0, 50.0, 17.0),
                size: Size(239.0, 120.0),
                pinLeft: true,
                fixedWidth: true,
                fixedHeight: true,
              ...
              Pinned.fromSize(
                ...
                child:
                  ...
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(3.5, 3.0, 28.0, 25.0),
                      size: Size(35.0, 35.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
          ...
          Positioned(
            ...
            children: <Widget>[
              ...
              Pinned.fromSize(
                bounds: Rect.fromLTWH(36.0, 75.0, 187.0, 38.0),
                size: Size(239.0, 120.0),
                pinLeft: true,
                pinRight: true,
                pinBottom: true,
              ...
              Pinned.fromSize(
                bounds: Rect.fromLTWH(163.0, 45.0, 60.0, 25.0),
                size: Size(239.0, 120.0),
                pinRight: true,
                fixedWidth: true,
                fixedHeight: true,
              ...
              Pinned.fromSize(
                bounds: Rect.fromLTWH(187.0, 0.0, 36.0, 35.0),
                size: Size(239.0, 120.0),
                pinRight: true,
                pinTop: true,
                fixedWidth: true,
                ...
                child:
                  ...
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 5.0, 36.0, 26.0),
                      size: Size(36.0, 35.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
